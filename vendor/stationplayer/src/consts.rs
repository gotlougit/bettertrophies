...
pub(crate) const DEFAULT_APP_VERSION: &str = "26.4.0";
pub(crate) const DEFAULT_APP_VER_HEADER: &str = "PlayStationApp-Android/26.4.0";
...
pub(crate) const DEFAULT_NOTIFICATION_TEMPLATE: &str = "26.04";
